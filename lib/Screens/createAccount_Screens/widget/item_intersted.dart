...
class InterestedItem extends StatefulWidget {
  ...
  final IconData interestedeIcon;
  @override
  State<InterestedItem> createState() => _InterestedItemState();
}

class _InterestedItemState extends State<InterestedItem> {
